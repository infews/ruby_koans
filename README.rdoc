...
operating specific instructions.  In order to run this you need Ruby, Rubygems, and
Bundler (the latter two are for Ruby package managerment) installed. To check the
installations simply type:
...
around 1.8.6 or more). Any version of Bundler will do.

Once you have Ruby, Rubygems, and Bundler installed clone this repo locally and:
